...
<?php
$redirecionamento = isset($_SESSION['id']) ? 'reclamar.php' : 'index.php';
?>
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            if (!isset($_SESSION['id'])) {
              echo '<li class="nav-item"><a class="nav-link" aria-current="index.php" href="index.php" title="Voltar a Página inicial do Site">Home</a> </li>';
            }
            ?>
  ...
  <div class="body">
    <h1 style="margin-top: 10px; font-size: 30px;">Página de Contatos</h1>

    <p>
      Precisa de ajuda ou quer saber mais sobre o Proto-on? Entre em contato conosco!<br><br>

    <div class="contato">
      <img src="Imagens/telefone.png" alt="Telefone" style="margin-right: 5px;">
      <span>Telefone: (11) 4676-3368</span>
    </div>

    <div class="contato">
      <img src="Imagens/whatsApp.png" alt="WhatsApp" style="margin-right: 5px;">
      <span>WhatsApp: (11) 96278-4605</span>
    </div>

    <div class="contato">
      <img src="Imagens/email.webp" alt="E-mail" style="margin-right: 5px;">
      <span>E-mail: proto_on@outlook.com</span>
    </div>

    <br>
    Além disso, estamos presentes nas redes sociais. Siga-nos para ficar por dentro das novidades e dicas sobre o Proto-on:<br><br>

    <div class="midia_social">
      <img src="Imagens/facebook.png" alt="Facebook" style="margin-right: 5px;">
      <span>Facebook: <a href="https://www.facebook.com/proto.on/">https://www.facebook.com/proto.on/</a></span>
    </div>

    <div class="midia_social">
      <img src="Imagens/instagram.webp" alt="Instagram" style="margin-right: 5px;">
      <span>Instagram: <a href="https://www.instagram.com/protoon">https://www.instagram.com/protoon</a></span>
    </div>

    <div class="midia_social">
      <img src="Imagens/twitterX.png" alt="Twitter" style="width: 50px; height: 30px; margin-right: 5px;">
      <span>Twitter: <a href="https://twitter.com/protoon">https://twitter.com/protoon</a></span>
    </div>
    </p>
  </div>


  <button type="button" class="btn btn-outline-dark voltar" style="margin-top: 20px;" onclick="window.location.href='<?php echo $redirecionamento; ?>'">Voltar</button>
